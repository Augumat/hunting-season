...
setblock 0 249 0 minecraft:chain_command_block[conditional=false,facing=down]{auto:1,Command:"execute as @p[team=runner,predicate=scrub:player_in_overworld] run execute as @a[team=hunter,predicate=scrub:player_in_overworld] run execute run title @s actionbar [\"\",{\"text\":\"[ \"},{\"score\":{\"name\":\"@s\",\"objective\":\"relX\"},\"color\":\"dark_green\"},{\"text\":\" | \"},{\"score\":{\"name\":\"@s\",\"objective\":\"relZ\"},\"color\":\"dark_green\"},{\"text\":\" ]\"}]"}
setblock 0 248 0 minecraft:chain_command_block[conditional=false,facing=down]{auto:1,Command:"execute as @p[team=runner,predicate=scrub:player_in_overworld] run execute as @a[team=hunter,predicate=!scrub:player_in_overworld] run execute run title @s actionbar [\"\",{\"text\":\"[ \"},{\"text\":\"relx\",\"obfuscated\":true,\"color\":\"dark_green\"},{\"text\":\" | \"},{\"text\":\"relz\",\"obfuscated\":true,\"color\":\"dark_green\"},{\"text\":\" ]\"}]"}
setblock 0 247 0 minecraft:chain_command_block[conditional=false,facing=down]{auto:1,Command:"execute as @p[team=runner,predicate=scrub:player_in_nether] run execute as @a[team=hunter,predicate=scrub:player_in_nether] run execute run title @s actionbar [\"\",{\"text\":\"[ \"},{\"score\":{\"name\":\"@s\",\"objective\":\"relX\"},\"color\":\"dark_red\"},{\"text\":\" | \"},{\"score\":{\"name\":\"@s\",\"objective\":\"relZ\"},\"color\":\"dark_red\"},{\"text\":\" ]\"}]"}
setblock 0 246 0 minecraft:chain_command_block[conditional=false,facing=down]{auto:1,Command:"execute as @p[team=runner,predicate=scrub:player_in_nether] run execute as @a[team=hunter,predicate=!scrub:player_in_nether] run execute run title @s actionbar [\"\",{\"text\":\"[ \"},{\"text\":\"relx\",\"obfuscated\":true,\"color\":\"dark_red\"},{\"text\":\" | \"},{\"text\":\"relz\",\"obfuscated\":true,\"color\":\"dark_red\"},{\"text\":\" ]\"}]"}
setblock 0 245 0 minecraft:chain_command_block[conditional=false,facing=down]{auto:1,Command:"execute as @p[team=runner,predicate=scrub:player_in_end] run execute as @a[team=hunter,predicate=scrub:player_in_end] run execute run title @s actionbar [\"\",{\"text\":\"[ \"},{\"score\":{\"name\":\"@s\",\"objective\":\"relX\"},\"color\":\"dark_purple\"},{\"text\":\" | \"},{\"score\":{\"name\":\"@s\",\"objective\":\"relZ\"},\"color\":\"dark_purple\"},{\"text\":\" ]\"}]"}
setblock 0 244 0 minecraft:chain_command_block[conditional=false,facing=down]{auto:1,Command:"execute as @p[team=runner,predicate=scrub:player_in_end] run execute as @a[team=hunter,predicate=!scrub:player_in_end] run execute run title @s actionbar [\"\",{\"text\":\"[ \"},{\"text\":\"relx\",\"obfuscated\":true,\"color\":\"dark_purple\"},{\"text\":\" | \"},{\"text\":\"relz\",\"obfuscated\":true,\"color\":\"dark_purple\"},{\"text\":\" ]\"}]"}
# win conditions
