...
execute store success score __dummy __succ run tellraw @p[team=runner] ""
execute if score __dummy __succ matches 1 run function scrub:huntingseason/zz_dev/dev_s
