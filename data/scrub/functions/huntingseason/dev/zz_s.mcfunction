...
setblock 0 249 0 minecraft:chain_command_block[conditional=false,facing=down]{auto:1,Command:"execute as @p[predicate=scrub:runner_in_overworld] run execute as @a[team=hunter] run execute run title @s actionbar [\"\",{\"text\":\"( \"},{\"score\":{\"name\":\"@s\",\"objective\":\"relX\"}},{\"text\":\", \"},{\"score\":{\"name\":\"@s\",\"objective\":\"relZ\"}},{\"text\":\" )\"}]"}
setblock 0 248 0 minecraft:chain_command_block[conditional=false,facing=down]{auto:1,Command:"execute as @p[predicate=scrub:runner_in_nether] run execute as @a[team=hunter] run execute run title @s actionbar [\"\",{\"text\":\"( \"},{\"text\":\"oooo\",\"obfuscated\":true,\"color\":\"dark_red\"},{\"text\":\", \"},{\"text\":\"oooo\",\"obfuscated\":true,\"color\":\"dark_red\"},{\"text\":\" )\"}]"}
setblock 0 247 0 minecraft:chain_command_block[conditional=false,facing=down]{auto:1,Command:"execute as @p[predicate=scrub:runner_in_end] run execute as @a[team=hunter] run execute run title @s actionbar [\"\",{\"text\":\"( \"},{\"text\":\"oooo\",\"obfuscated\":true,\"color\":\"dark_purple\"},{\"text\":\", \"},{\"text\":\"oooo\",\"obfuscated\":true,\"color\":\"dark_purple\"},{\"text\":\" )\"}]"}
setblock 0 246 0 minecraft:chain_command_block[conditional=false,facing=down]{auto:1,Command:"execute if score @p[team=runner] runnerWins matches 1 run function scrub:huntingseason/dev/zz_w"}
setblock 0 245 0 minecraft:chain_command_block[conditional=false,facing=down]{auto:1,Command:"execute if score @p[team=runner] runnerLoses matches 1 run function scrub:huntingseason/dev/zz_l"}

# start the countdown chain
function scrub:huntingseason/dev/zz_5