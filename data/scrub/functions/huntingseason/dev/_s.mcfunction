...
setblock 0 252 0 minecraft:chain_command_block[conditional=false,facing=down]{auto:1,Command:"execute if score @p[scores={hunted=1}] Dim matches 0 run title @a[scores={hunted=0}] actionbar [\"\",{\"text\":\"( \"},{\"score\":{\"name\":\"@p[scores={hunted=1}]\",\"objective\":\"posX\"}},{\"text\":\", \"},{\"score\":{\"name\":\"@p[scores={hunted=1}]\",\"objective\":\"posZ\"}},{\"text\":\" )\"}]"}
setblock 0 251 0 minecraft:chain_command_block[conditional=false,facing=down]{auto:1,Command:"execute if score @p[scores={hunted=1}] Dim matches -1 run title @a[scores={hunted=0}] actionbar [\"\",{\"text\":\"( \"},{\"text\":\"oooo\",\"obfuscated\":true,\"color\":\"dark_red\"},{\"text\":\", \"},{\"text\":\"oooo\",\"obfuscated\":true,\"color\":\"dark_red\"},{\"text\":\" )\"}]"}
setblock 0 250 0 minecraft:chain_command_block[conditional=false,facing=down]{auto:1,Command:"execute if score @p[scores={hunted=1}] Dim matches 1 run title @a[scores={hunted=0}] actionbar [\"\",{\"text\":\"( \"},{\"text\":\"oooo\",\"obfuscated\":true,\"color\":\"dark_purple\"},{\"text\":\", \"},{\"text\":\"oooo\",\"obfuscated\":true,\"color\":\"dark_purple\"},{\"text\":\" )\"}]"}
